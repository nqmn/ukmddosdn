...
class L3RouterController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.subnet_gateways = {
            '192.168.10.0/24': {'gateway_ip': '192.168.10.1', 'gateway_mac': '00:00:00:00:10:01'},
            '192.168.20.0/24': {'gateway_ip': '192.168.20.1', 'gateway_mac': '00:00:00:00:20:01'},
            '192.168.30.0/24': {'gateway_ip': '192.168.30.1', 'gateway_mac': '00:00:00:00:30:01'},
            '192.168.0.0/24': {'gateway_ip': '192.168.0.1', 'gateway_mac': '00:00:00:00:00:01'}  # Controller network
        }
